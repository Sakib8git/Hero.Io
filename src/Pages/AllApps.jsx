          ...
          <div className="card bg-base-100  shadow-md border border-gray-100">
            ...
            <div className="card-body text-center">
              ...
              <div className="flex justify-between items-center mt-2 px-0">
                {/* Downloads */}
                <div className="flex items-center gap-1 text-green-600 text-sm bg-[#E3F9E5] p-2 rounded-md">
                  <img className="w-3" src={down} alt="" />
                  <span>{downloads} M</span>
                </div>

                {/* Rating */}
                <div className="flex items-center gap-1 text-orange-400 text-sm bg-[#FFECE3] p-2 rounded-md">
